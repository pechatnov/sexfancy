...
foreach($arResult['SECTIONS'] as $arSection){
	...
	if($arSection['DEPTH_LEVEL'] == '1') {
		...
		$arSection['IMG'] = CFile::ResizeImageGet($arSection["PICTURE"]['ID'], array('width'=>370, 'height'=>250), BX_RESIZE_IMAGE_EXACT, true);
		$sections['list'][$arSection['ID']] = $arSection;
	}
}
...
$sections = array_values($sections['list']);

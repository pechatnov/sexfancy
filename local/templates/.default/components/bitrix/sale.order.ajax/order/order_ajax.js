...
function updateColor(){
	BX.ready(function(){
		...
		var color_list = JSON.parse(document.getElementById('color_list').value);
		var update_data = $('#bx-soa-basket .bx-soa-item-td:nth-child(2) span');
		console.log(update_data);


		$.each(update_data, function (index, value) {
			console.log();
			$(this).text(color_list[$(this).text()])
		});

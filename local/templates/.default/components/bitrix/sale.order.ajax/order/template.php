...
else
{
	...
	?>
	<form class="ordering" action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		<?
...
while($ob = $res->GetNextElement())
{
	...
	$color[$arFields['PROPERTY_CODE_VALUE']] = $arFields['NAME'];
}
?>
	<input id="color_list" type="hidden" value='<?=json_encode($color, JSON_UNESCAPED_UNICODE)?>'>